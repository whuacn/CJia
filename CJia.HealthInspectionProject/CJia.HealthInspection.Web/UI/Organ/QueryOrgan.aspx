<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryOrgan.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.Organ.QueryOrgan" %>
     ...
     <form id="frm_Main" runat="server">
        ...
        <ext:Panel ID="pnl_Main" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
            ...
            <Items>
                ...
                DataKeyNames="ORGAN_ID" AutoScroll="true" EnableRowDoubleClick="true" OnSort="gr_Main_Sort">
                <Columns>
                        <ext:BoundField HeaderText="组织编号" SortField="ORGAN_NO" DataField="ORGAN_NO" />
                        <ext:BoundField HeaderText="组织名称" ExpandUnusedSpace="true" SortField="ORGAN_NAME" DataField="ORGAN_NAME" />
                        <ext:BoundField HeaderText="区域代码" ExpandUnusedSpace="true" SortField="AREA_CODE" DataField="AREA_CODE" />
                        <ext:BoundField HeaderText="区域名称" ExpandUnusedSpace="true" SortField="AREA_NAME" DataField="AREA_NAME" />
