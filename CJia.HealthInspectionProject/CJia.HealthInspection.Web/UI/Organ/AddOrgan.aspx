<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddOrgan.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.Organ.AddOrgan" %>
                    ...
                    <ext:FormRow ColumnWidths="30% 30% 40%">
                        <Items>
                            ...
                            <%--<ext:DropDownList ID="ddlArea" runat="server" Label="区域代码" EnableSimulateTree="true">                       
                             ...
                             <ext:TextBox ID="txtArea" ShowRedStar="true" runat="server" ShowEmptyLabel="true" EmptyText="请在下列展开树中选择区域" Label="区域名称" Readonly="true" MaxLength="100" Text="" Required="True"></ext:TextBox>
                        </Items>
                    </ext:FormRow> 
                 <ext:FormRow ColumnWidths="100%">
                     <Items>
                      <ext:Tree ID="treeArea" OnNodeCommand="treeArea_NodeCommand" ShowHeader="false" Title="区域选择" runat="server">
                            </ext:Tree>
                         </Items>
                 </ext:FormRow>
                </Rows>
