<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExeTask.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.ExeTask.ExeTask" %>
                            ...
                            <Rows>
                                ...
                                <ext:FormRow ColumnWidths="85% 15%">
                                    <Items>
                                        ...
                                        <ext:Button ID="btn_selectTask" IconUrl="../../Icons/zoom_in.png" runat="server" Text="选择任务" OnClick="btn_selectTask_Click" ></ext:Button>
                                    </Items>
                                </ext:FormRow>
                                ...
                                <ext:FormRow ColumnWidths="100%">
                                    <Items>
                                        <ext:TextBox ID="txt_address" AutoPostBack="true" ShowRedStar="true" runat="server" Label="检查地点" MaxLength="100" Text="" Required="True"></ext:TextBox>
                                    </Items>
                                </ext:FormRow>
                                <ext:FormRow ColumnWidths="50% 50%">
                                    <Items>
                        ...
                        <ext:Panel ID="pnl_Main" runat="server" EnableBackgroundColor="true" BodyPadding="2 2 2 2"
                            ...
                            <Items>
                                <ext:Grid ID="gridCheckTitle" ShowHeader="False" runat="server" AllowSorting="true" PageSize="20" ShowBorder="true" AllowPaging="true" EnableTextSelection="true" IsDatabasePaging="true"  
                                    EnableCheckBoxSelect="false"  EnableMultiSelect="false" DataKeyNames="CHECK_TITLE_ID" AutoScroll="true" EnableRowDoubleClick="true" OnPageIndexChange="gr_Main_PageIndexChange" EnableRowNumber="True">
                                    <Columns>
