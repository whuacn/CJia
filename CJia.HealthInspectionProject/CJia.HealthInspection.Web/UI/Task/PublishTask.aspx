<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublishTask.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.Task.PublishTask" %>
                ...
                <ext:FormRow ColumnWidths="35% 20% 45%">
                    <Items>
                        ...
                        <ext:Grid ID="gridFiles" runat="server" Title="文件信息" ShowHeader="False" PageSize="18" ShowBorder="true"
                            IsDatabasePaging="true" AutoHeight="true" DataKeyNames="FILE_ID" AutoScroll="true" OnRowCommand="gridFiles_RowCommand">
                            <Columns>
