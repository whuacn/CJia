<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectOrgan.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.Dept.SelectOrgan" %>
                                ...
                                <ext:Toolbar ID="tlr_Btn" runat="server">
                                    <Items>
                                        ...
                                        <ext:TwinTriggerBox ID="ttbSearch" runat="server" Width="150" EmptyText="输入要搜索的关键字"
                                            ShowTrigger1="false" Trigger1Icon="Clear" Trigger2Icon="Search" OnTrigger2Click="ttbSearch_Trigger2Click">
                                        </ext:TwinTriggerBox>
                                    </Items>
                                </ext:Toolbar>
                            </Toolbars>
                            <Items>
                                <ext:Grid ID="gridOrgan" ShowHeader="False" runat="server" AllowSorting="true" PageSize="20" ShowBorder="true" AllowPaging="true" EnableTextSelection="true"
                                    IsDatabasePaging="true" OnPageIndexChange="gr_Main_PageIndexChange" EnableCheckBoxSelect="true" OnSort="gr_Main_Sort" EnableMultiSelect="false"
                                     DataKeyNames="ORGAN_ID" AutoScroll="true" EnableRowDoubleClick="true" OnRowDoubleClick="gridOrgan_RowDoubleClick">
                                    <Columns>
                                         <ext:BoundField DataToolTipField="ORGAN_NO"  HeaderText="组织编号" SortField="ORGAN_NO" DataField="ORGAN_NO" ExpandUnusedSpace="true" />
