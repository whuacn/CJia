<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditDept.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.Dept.EditDept" %>
             ...
             <Rows>
                    <ext:FormRow ColumnWidths="30% 30% 30% 10%">
                        <Items>
                            ...
                            <ext:TextBox ID="txtOrganName" ShowRedStar="true" runat="server" Label="组织名称" MaxLength="100" Readonly="true" Text="" Required="True"></ext:TextBox>
