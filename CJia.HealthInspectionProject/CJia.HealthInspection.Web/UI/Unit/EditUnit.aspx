<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditUnit.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.Unit.EditUnit" %>
     ...
     <form id="frm_Main" runat="server">
        ...
        <ext:Form ID="sf_Edit" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
            ...
            <Rows>
                ...
                <ext:FormRow ColumnWidths="34% 33% 33%">
                    <Items>
                        <ext:DatePicker ID="dpk_xuke" Label="许可日期" runat="server"></ext:DatePicker>
