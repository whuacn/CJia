<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReadExeTask.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.QueryCheckTask.ReadExeTask" %>
                        ...
                        <ext:Form ID="sf_Edit" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
                            ...
                            <Rows>
                                ...
                                <ext:FormRow ColumnWidths="50% 50%">
                                    <Items>
                                        <ext:TextBox ID="txt_Task" ShowRedStar="true" runat="server" Label="任务名称" Readonly="true" MaxLength="100" Text=""></ext:TextBox>
                                        <ext:TextBox ID="txt_OrganName" ShowRedStar="true" runat="server" Label="下达机关" Readonly="true" MaxLength="100" Text=""></ext:TextBox>
                                    </Items>
                                </ext:FormRow>
                                <ext:FormRow ColumnWidths="50% 50%">
                                    <Items>
