<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTemplate.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.Template.AddTemplate" %>
                                ...
                                <ext:Toolbar ID="Toolbar1" runat="server" Width="500px" CssClass="fontSize">
                                    <Items>
                                        <ext:Form ID="sf_Edit" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
                                            AutoScroll="true" LabelWidth="70px" CssClass="fontSize" BodyPadding="10px 10px" runat="server" EnableCollapse="True" Width="500px" ColumnWidth="500px">
                                            <Rows>
                                                ...
                                                <ext:FormRow ColumnWidths="100%">
                                                    <Items>
                                                        <ext:DropDownList ID="ddl_Big" AutoPostBack="true" runat="server" Label="大分类" EnableSimulateTree="false" ShowRedStar="true" OnSelectedIndexChanged="ddl_Big_SelectedIndexChanged">
                                                        </ext:DropDownList>
                                                    </Items>
                                                </ext:FormRow>
                                                <ext:FormRow ColumnWidths="100%">
                                                    <Items>
                                                        <ext:DropDownList ID="ddl_Middle" AutoPostBack="true" runat="server" Label="中分类" EnableSimulateTree="false" ShowRedStar="true" OnSelectedIndexChanged="ddl_Middle_SelectedIndexChanged">
                                                        </ext:DropDownList>
                                                    </Items>
                                                </ext:FormRow>
                                                <ext:FormRow ColumnWidths="100%">
                                                    <Items>
                                                        <ext:DropDownList ID="ddl_Small" runat="server" Label="小分类" EnableSimulateTree="false" ShowRedStar="true">
                                                        </ext:DropDownList>
                                                    </Items>
                                                </ext:FormRow>
                                            </Rows>
                            ...
                            <Items>
                                <ext:Grid ID="gr_title" ShowHeader="false" Title="添加检查题目" runat="server" AllowSorting="true" PageSize="20" ShowBorder="true" AllowPaging="true" EnableTextSelection="true"
                                    ...
                                    <Columns>
                                        ...
                                        <ext:LinkButtonField ConfirmTarget="Top" IconUrl="../../Icons/page_header_footer.png" ToolTip="详情" ColumnID="lbf_Edit" HeaderText="&nbsp;" Width="35px" CommandName="Details" Text="" />
                            ...
                            <Toolbars>
                                <ext:Toolbar ID="tbr_Search" Position="Bottom" runat="server">
                                    <Items>
                                        ...
                                        <ext:Button ID="btn_Save" Text="保存" ConfirmText="确定添加此模板吗？" ValidateForms="sf_Edit" runat="server" Icon="TextRuler" OnClick="btn_Save_Click">
                                        </ext:Button>
                                    </Items>
                                </ext:Toolbar>
                            </Toolbars>
                            ...
                            <Toolbars>
                                <ext:Toolbar ID="tlr_Btn" runat="server">
                                    <Items>
                                        ...
                                        <ext:DropDownList ID="ddl_Big2" AutoPostBack="true" Width="170" OnSelectedIndexChanged="ddl_Big2_SelectedIndexChanged" runat="server">
                                        </ext:DropDownList>
                                        <ext:Label ID="Label4" runat="server" Width="6"></ext:Label>
                                        <ext:DropDownList ID="ddl_Middle2" AutoPostBack="true" runat="server" EnableSimulateTree="false" ShowRedStar="true" Width="170" OnSelectedIndexChanged="ddl_Middle2_SelectedIndexChanged">
                                        </ext:DropDownList>
                                        <ext:Label ID="Label5" runat="server" Width="6"></ext:Label>
                                        <ext:DropDownList ID="ddl_Small2" runat="server" EnableSimulateTree="true" Width="170">
                                        </ext:DropDownList>
                                        <ext:Label ID="Label2" runat="server" Width="6"></ext:Label>
                                        <ext:Button runat="server" IconUrl="../../Icons/zoom.png" Text="查询" ID="btn_Select" OnClick="btn_Select_Click" Type="Button"></ext:Button>
                                    </Items>
                                </ext:Toolbar>
                            </Toolbars>
                            <Items>
                                <ext:Grid ID="gr_Main" ShowHeader="False" runat="server" EnableCheckBoxSelect="true" AllowSorting="true" PageSize="20" ShowBorder="true" AllowPaging="true" EnableTextSelection="true"
                                    ...
                                    <Columns>
                                        ...
                                        <%--<ext:CheckBoxField SortField="IS_CHOICE" Width="50px" RenderAsStaticField="True" CommandName="cb_choice" DataField="IS_CHOICE" HeaderText="选择题" />--%>
                                        <ext:LinkButtonField ConfirmTarget="Top" IconUrl="../../Icons/page_header_footer.png" ToolTip="详情" ColumnID="lbf_Edit" HeaderText="&nbsp;" Width="35px" CommandName="Details" Text="" />
                                        <ext:LinkButtonField Icon="Add" ConfirmTarget="Top" ToolTip="添加" ColumnID="lbf_Delete" HeaderText="&nbsp;" Width="35px" CommandName="Add" Text="" />
                                    </Columns>
                                </ext:Grid>
                            </Items>
                            <Toolbars>
