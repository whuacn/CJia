<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.ChangePassword" %>
                ...
                <ext:SimpleForm LabelWidth="75px" ID="sf_Main" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
                    ...
                    <Items>
                        <ext:TextBox ID="txt_OldPasswdD" runat="server" Label="旧的密码"
                            Text="" MaxLength="100" TextMode="Password" NextFocusControl="txt_NewPasswdD" Required="true">
                        </ext:TextBox>
                        <ext:TextBox ID="txt_NewPasswdD" runat="server" Label="新的密码"
                            Text="" MaxLength="100" TextMode="Password" NextFocusControl="txt_ConfirmPasswdD" Required="true">
                        </ext:TextBox>
                        <ext:TextBox ID="txt_ConfirmPasswdD" runat="server" Label="确认密码"
                            Text="" MaxLength="100" TextMode="Password" NextFocusControl="btn_Submit" Required="true" CompareControl="txt_NewPasswdD"
                            CompareOperator="Equal" CompareMessage="新密码必须与确认密码相同！">
                        </ext:TextBox>
