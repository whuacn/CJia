<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryUser.aspx.cs" Inherits="CJia.HealthInspection.Web.UI.User.QueryUser" %>
    ...
    <form id="frm_Main" runat="server">
        ...
        <ext:Panel ID="pnl_Main" runat="server" EnableBackgroundColor="true" BodyPadding="3px"
            ...
            <Items>
                ...
                <Columns>
                        <ext:BoundField HeaderText="监督人员编号" SortField="USER_NO" DataField="USER_NO" />
                        <ext:BoundField HeaderText="监督人员名称" Width="160px" SortField="USER_NAME" DataField="USER_NAME" />
                        <ext:BoundField HeaderText="用户类型" Width="120px" SortField="USER_TYPE_NAME" DataField="USER_TYPE_NAME" />
                         <ext:BoundField HeaderText="角色名称" Width="120px" SortField="ROLE_NAME" DataField="ROLE_NAME" />
                        ...
                        <ext:BoundField HeaderText="" Width="120px" SortField="USER_TYPE" Hidden="true" DataField="USER_TYPE" />
                    </Columns>
                </ext:Grid>
            </Items>
        </ext:Panel>
