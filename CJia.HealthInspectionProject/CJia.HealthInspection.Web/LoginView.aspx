<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginView.aspx.cs" Inherits="CJia.HealthInspection.Web.LoginView" %>
...
<body>
    <%--<form id="form1"  defaultbutton="btnLogin1">--%>
    <form class="signup_form_form" runat="server" id="signup_form" method="post" action="" data-secure-action="" data-secure-ajax-action="">
        <div class='signup_container'>
            ...
            <div id="signup_forms" class="signup_forms clearfix">
                ...
                <div class="form_row">
                    <label for="signup_code">请输入验证码</label><%--<div  class='tip error'></div>--%>
            ...
            <div class="login-btn-set">
                ...
                <%--<asp:LinkButton ID="btnLogin" runat="server" class='login-btn' OnClick="Login_Click"></asp:LinkButton>--%>
