<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CJia.HealthInspection.Web.Default" %>
        ...
        <ext:RegionPanel ID="rpnl_Main" ShowBorder="false" runat="server">
            <Regions>
                ...
                <ext:Region ID="ren_Left" Split="true" EnableSplitTip="true" CollapseMode="Mini" EnableCollapse="true" Width="180px" ShowHeader="true"
                    ...
                    <Items>
                        <ext:Accordion ID="ad_Main" runat="server" ShowHeader="false" ShowBorder="false" BodyPadding="2px" OnInit="ren_Left_Init" >
                            <Panes>
                                <ext:AccordionPane ID="ap_MBasic" Icon="FolderWrench" Hidden="true" Expanded="false"  Title="单位管理" runat="server" Layout="Fit">
                                    <Items>
