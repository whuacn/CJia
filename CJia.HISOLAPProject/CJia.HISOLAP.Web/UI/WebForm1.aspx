<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="CJia.HISOLAP.Web.UI.WebForm1" %>
                            ...
                            <Toolbars>
                                <ext:Toolbar ID="Toolbar1" Position="Bottom" runat="server">
                                    <Items>
                                        ...
                                        <ext:Button runat="server" ID="btn_visualNext" ClientIDMode="Static" Hidden="true"></ext:Button>
                                        <ext:Button ID="btn_LastTitle" IconUrl="../Icons/table_column.png" runat="server" Text="   上一题   " ></ext:Button>
                                        <ext:Button ID="btn_NextTitle" IconUrl="../Icons/table_column.png" runat="server" Text="   下一题   " ></ext:Button>
