...
{
    public partial class SurguryComplication : DevExpress.XtraEditors.XtraUserControl
    {
        public SurguryComplication()
        {
            InitializeComponent();
        ...
        {
            Report.OutoReport v = new Report.OutoReport(Report.ReportType.Horizontal);
