...
namespace CJia.HISOLAP.Tools
{
    public static class Help
    {
        ...
        public static bool SystemInitConfig()
        {
            try
            {
                CJia.ClientConfig.ServerIP = CJia.HISOLAP.Tools.ConfigHelper.GetAppStrings("Host");
                CJia.ClientConfig.ServerPort = int.Parse(CJia.HISOLAP.Tools.ConfigHelper.GetAppStrings("Port"));
                CJia.ClientConfig.ClientNo = CJia.HISOLAP.Tools.ConfigHelper.GetAppStrings("ClientNo");
                CJia.ClientConfig.SystemNo = CJia.HISOLAP.Tools.ConfigHelper.GetAppStrings("SystemNo");
        ...
        /// </summary>
        /// <param name="uc"></param>
        public static void NewRedBorderShowFrom(UserControl uc)
        {
            Form frm = new Form();
            frm.FormBorderStyle = FormBorderStyle.None;
            frm.StartPosition = FormStartPosition.CenterScreen;
