...
{
    public partial class PictureInputView : CJia.Health.Tools.View, CJia.Health.Views.IImagesInputView, IMessageFilter
    {
        ...
        public void CaptureImage()
        {
            ...
            string fileName = LURecordNO.DisplayText + "_" + strs[0] + "_" + strs[1] + "_" + strs[2] + CJia.Health.Tools.ConfigHelper.GetAppStrings("ImgExtension");
