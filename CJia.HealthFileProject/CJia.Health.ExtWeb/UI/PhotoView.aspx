...
<body>
     <form id="frm_Main" runat="server">
        ...
        <ext:RegionPanel ID="rpnl_Main" ShowBorder="false" runat="server">
            <Regions>
                <ext:Region ID="ren_Center" Title="病人基本信息" ShowHeader="true" Layout="Row" Position="Left" Margins="2 2 2 0" runat="server" Width="200px">
                    <Items>
                        <ext:Panel ID="Panel2" runat="server" ShowHeader="false" ShowBorder="false">
                            <Items>
                        ...
                        <ext:Panel ID="Panel3" runat="server" RowHeight="100%" Layout="Fit" ShowHeader="false">
                            <Items>
                ...
                <ext:Region ID="ren_Right" Title="图像浏览" Split="true"
                    ...
                    <Items>
                        <ext:Panel ID="Panel4" runat="server" EnableBackgroundColor="true" BodyPadding="2 2 2 2"
