<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientInfoView.aspx.cs" Inherits="CJia.Health.Web.UI.PatientInfoView" %>
        ...
        <div>
            <table width="100%" style="text-align: left; font-family: 宋体; font-size: 18px;">
                <tr style="height: 30px">
                    <td colspan="7" style="text-align: center; font-weight: bold; font-size: 20px; color: #000000;">病人基本信息
                    </td>
                </tr>
                <tr style="height: 30px">
