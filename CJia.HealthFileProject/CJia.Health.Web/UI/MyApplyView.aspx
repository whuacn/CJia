<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyApplyView.aspx.cs" Inherits="CJia.Health.Web.UI.MyApplyView" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="lblMsg" runat="server" Text="对不起，您没有正在申请的病案。。。" Visible="False"></asp:Label>
                                ...
                                <asp:TemplateField HeaderText="操作">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnDelete" runat="server" CommandArgument='<%# Eval("BORROW_LIST_ID") %>'
                                            CommandName="MyDelete" OnClientClick="return confirm('确认撤销申请吗?')" Font-Bold="True" ForeColor="Red" Font-Underline="False">
                                            <asp:Label ID="lblFlag1" runat="server" Text='撤销申请'></asp:Label>
                                        </asp:LinkButton>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Center" />
                                </asp:TemplateField>
