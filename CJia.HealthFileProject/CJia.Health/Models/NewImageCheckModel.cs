...
{
    public class NewImageCheckModel : CJia.Health.Tools.Model
    {
        /// <summary>
        /// 查询图片信息
        /// </summary>
        ...
        public DataTable SelectPic(string healthId)
        {
            ...
            DataTable AllPicture = CJia.DefaultOleDb.Query(CJia.Health.Models.SqlTools.SqlSelectAllPicture, parames);
            return AllPicture;
        }
