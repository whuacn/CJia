...
namespace CJia.Health.Presenters
{
    public class ProjectManagePresenter : CJia.Health.Tools.Presenter<Models.ProjectManageModel, Views.IProjectManageView>
    {
        ...
        {
            bool IsInsert = Model.InsertProject(e.ProjectName, e.ProNo, e.ProPinyin, e.UserID, e.isPrint, e.shortKey);
            if (IsInsert)
            {
        ...
        {
            bool IsUpdate = Model.UpdateProject(e.ProjectName, e.ProNo, e.ProPinyin, e.UserID, e.ProId, e.isPrint, e.shortKey);
            if (IsUpdate)
            {
