...
namespace CJia.PIVAS.App.UI
{
    ...
    public partial class LoginView : CJia.PIVAS.Tools.View, CJia.PIVAS.Views.ILoginView
    {
        ...
        {
            string systemStyle = CJia.PIVAS.Tools.ConfigHelper.GetAppStrings("SystemStyle");
            if(systemStyle == "nurse")
            {
                this.lbcSystemName.Text = "静脉配置中心系统(护士站)";
            }
        }
        ...
        private void Login()
        {
            ...
            loginArgs.UserNo = txtUserAccount.Text.ToUpper();
