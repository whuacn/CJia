...
namespace CJia.PIVAS.Views
{
    ...
    public interface ICheckAdviceView:Tools.IView
    {
        ...
        /// 配伍禁忌
        /// </summary>
        event EventHandler<CheckAdviceArgs> OnPWJJ;
    ...
    public class CheckAdviceArgs : EventArgs
    {
        ...
        /// 成组药品类别--精神药
        /// </summary>
        public bool IsTypeJSY;

        /// <summary>
        /// 成组药品类别--毒麻药
        /// </summary>
        public bool IsTypeDMY;

        /// <summary>
        /// 成组药品类别--贵重药
        /// </summary>
        public bool IsTypeGCY;
        ...
        /// 是否选择了临时
        /// </summary>
        public bool CheckTemporary;

        /// <summary>
        /// 长期临时标志
        /// </summary>
        public string LongTimeStatus;
