...
namespace CJia.PIVAS
{
    ...
    public static class User
    {
        ...
        public static string hisUserId;
        ...
        public static void SetUser(bool isLoginSuccess, long usreId, string userNo, string userName, string deptNo, string deptName, string pwd, string logTime,string isAdmin,string hisUserId,string crole)
        {
