...
group by nog.pharm_id,
 ...
 order by t.illfield_name, t.illfield_id, t.bed_id";
       ...
       SUM(DECODE(BATCH_ID, 1000000004, 1, 0)) BATCH_LABEL_COUNTZ, --zsp
       SUM(DECODE(BATCH_ID, 1000000005, 1, 0)) BATCH_LABEL_COUNTW, --db2
       SUM(DECODE(BATCH_ID, 2000000020, 1, 0)) BATCH_LABEL_COUNTB, --db
       SUM(DECODE(BATCH_ID, 2000000021, 1, 0)) BATCH_LABEL_COUNTL, --ls
