...
namespace CJia.PIVAS.Models.DataManage
{
    ...
    public class AddUserModel : CJia.PIVAS.Tools.Model
    {
        ...
        /// <returns></returns>
        public bool InsertUser(string userNo,string userName,string pwd,string deptId,string deptName, long createBy,string isAdmin)
        {
            object[] obInsert = new object[] { userNo, userName, pwd, deptId, deptName, createBy, isAdmin };
