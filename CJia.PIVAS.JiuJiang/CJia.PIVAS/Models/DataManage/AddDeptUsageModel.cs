...
namespace CJia.PIVAS.Models.DataManage
{
    ...
    public class AddDeptUsageModel : CJia.PIVAS.Tools.Model
    {
        ...
        /// <returns></returns>
        public bool InsertPivas(string officeId, string officeName, long usageId, string usageName, long createBy, bool checkLong, bool checkTemporary)
        {
            string checkStr = "";
            if(checkLong)
            {
            ...
            object[] obInsert = new object[] { officeId, officeName, usageId, usageName, createBy, checkStr };
