...
namespace CJia.PIVAS.Tools
{
    ...
    public sealed class Message
    {
        ...
        public static void Show(string MsgHint)
        {
            ...
            CJia.PIVAS.Models.PIVASModel.WriteLog(MsgHint);
        }
        /// <summary>
        /// 显示警告信息
        /// </summary>
        ...
        public static void ShowWarning(string MsgWarning)
        {
            ...
            CJia.PIVAS.Models.PIVASModel.WriteLog(MsgWarning);
        }
        /// <summary>
        /// 显示停止信息
        /// </summary>
        ...
        public static void ShowStop(string MsgStop)
        {
            ...
            CJia.PIVAS.Models.PIVASModel.WriteLog(MsgStop);
        }
        /// <summary>
        ...
        public static Result ShowQuery(string MsgQuery)
        {
            ...
            CJia.PIVAS.Models.PIVASModel.WriteLog(MsgQuery);
        }
        /// <summary>
        /// 显示询问消息
        /// </summary>
