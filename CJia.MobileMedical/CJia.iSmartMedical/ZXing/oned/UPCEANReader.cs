...
namespace com.google.zxing.oned
{
	...
	public abstract class UPCEANReader:OneDReader
	{
		...
		public override Result decodeRow(int rowNumber, BitArray row, Dictionary<object, object> hints)
		{
		...
		/// </summary>
		public virtual Result decodeRow(int rowNumber, BitArray row, int[] startGuardRange, Dictionary<object, object> hints)
		{
