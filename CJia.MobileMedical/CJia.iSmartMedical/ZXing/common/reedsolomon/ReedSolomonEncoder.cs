...
namespace com.google.zxing.common.reedsolomon
{
	...
	public sealed class ReedSolomonEncoder
	{
		...
		private List<object> cachedGenerators;
		...
		public ReedSolomonEncoder(GF256 field)
		{
			...
			this.field = field;
            this.cachedGenerators = new List<object>();//System.Collections.ArrayList.Synchronized(new System.Collections.ArrayList(10));
