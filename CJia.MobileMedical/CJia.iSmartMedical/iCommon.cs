...
namespace CJia.iSmartMedical
{
    public class iCommon
    {
        ...
        public static Data.iDevice CurrentDevice = null;

        public static List<Data.iDeviceOffice> DeviceOffice = null;
        #endregion
        ...
        #region 同步事件
        public static event EventHandler<CheckLogSyncEventArgs> CheckLogSyncComplet;
        public static void OnCheckLogSyncComplet(EventArgs SyncArg)
        {
            if (CheckLogSyncComplet != null)
            {
                CheckLogSyncComplet(null, SyncArg as CheckLogSyncEventArgs);
            }
        }
        #endregion
    }

    public class CheckLogSyncEventArgs : EventArgs
    {
        public CheckLogSyncEventArgs()
        {
            
        }
        public List<string> DCLID = new List<string>();
        public List<string> InhosID = new List<string>();
        public List<string> ChangeType = new List<string>();
        public List<byte[]> MedicalLog = new List<byte[]>();
        public List<byte[]> PhotoLog = new List<byte[]>();
    }
}
