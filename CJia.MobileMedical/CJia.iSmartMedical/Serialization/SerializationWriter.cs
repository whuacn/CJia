...
namespace CJia.iSmartMedical.Serialization
{
    /// <summary>
    ...
    public sealed class SerializationWriter : BinaryWriter
    {
        ...
        readonly Dictionary<object, object> objectTokenLookup;
...
#if DEBUG
        /// <summary>
        ///  type usage member in which counters are stored of all the known types
        ///  emitted into the output stream. For debugging purposes.
        /// </summary>
            ...
            : base(stream)
        {
            ...
            objectTokenLookup = new Dictionary<object, object>();//new Hashtable();
        ...
        {
            return true;
            //return type(Type.EmptyTypes) != null;
        }
