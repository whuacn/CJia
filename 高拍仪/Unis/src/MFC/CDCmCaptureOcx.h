...
public:
	...
	void SetMarkPic(LPCTSTR FilePath)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x2e, DISPATCH_METHOD, VT_EMPTY, NULL, parms, FilePath);
	}
	...
	CString GetDevDisplayName(long Index)
	{
		CString result;
		static BYTE parms[] = VTS_I4 ;
	...
	CString CaptureBinaryImg(unsigned char * lpBuf, long * Width, long * Height, long * nLine, long * bpp)
	{
		CString result;
		static BYTE parms[] = VTS_PUI1 VTS_PI4 VTS_PI4 VTS_PI4 VTS_PI4 ;
		InvokeHelper(0x35, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, lpBuf, Width, Height, nLine, bpp);
		return result;
	}
	CString GetFileNameOnDirectory(long Index)
	{
		CString result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x36, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, Index);
		return result;
	}
	long GetDirectoryFileCount(LPCTSTR strDirPath)
	{
		long result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x37, DISPATCH_METHOD, VT_I4, (void*)&result, parms, strDirPath);
		return result;
	}
	CString CaptureImageEx(LPCTSTR FileName)
	{
		CString result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x38, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, FileName);
		return result;
	}
	long SetCurrentDevDPI(float xdpi, float ydpi)
	{
		...
		InvokeHelper(0x39, DISPATCH_METHOD, VT_I4, (void*)&result, parms, xdpi, ydpi);
		return result;
	}
	long SetMarkString(long Angel, long size, LPCTSTR String)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_BSTR ;
		InvokeHelper(0x3a, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Angel, size, String);
		return result;
	}
	long SetTimeMark(LPCTSTR Time, long size)
	{
		long result;
		static BYTE parms[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0x3b, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Time, size);
		return result;
	}
	long GetLastImageInfoEx(long * Width, long * Height, long * bpp)
	{
		...
		InvokeHelper(0x3c, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Width, Height, bpp);
		return result;
	}
	long UploadFile(LPCTSTR FilePath, long bFileDelete, LPCTSTR FtpAdd, LPCTSTR UserName, LPCTSTR UserPsd, LPCTSTR TargetName)
	{
		long result;
		static BYTE parms[] = VTS_BSTR VTS_I4 VTS_BSTR VTS_BSTR VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x3d, DISPATCH_METHOD, VT_I4, (void*)&result, parms, FilePath, bFileDelete, FtpAdd, UserName, UserPsd, TargetName);
		return result;
	}
	long GetLastImageInfo(LPCTSTR FileName)
	{
		long result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x3e, DISPATCH_METHOD, VT_I4, (void*)&result, parms, FileName);
		return result;
	}
	long SetMarkStringEx(long Angel, long size, LPCTSTR String, unsigned long color, long FontIndex, long X, long Y, long mode)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_BSTR VTS_UI4 VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x3f, DISPATCH_METHOD, VT_I4, (void*)&result, parms, Angel, size, String, color, FontIndex, X, Y, mode);
		return result;
	}
	long CombineTwoImage(LPCTSTR imageFileName, LPCTSTR imageFileName1, LPCTSTR imageFileName2, long type)
	{
		long result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_BSTR VTS_I4 ;
		InvokeHelper(0x40, DISPATCH_METHOD, VT_I4, (void*)&result, parms, imageFileName, imageFileName1, imageFileName2, type);
		return result;
	}
	long SetCusCropType(long type)
	{
		long result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x41, DISPATCH_METHOD, VT_I4, (void*)&result, parms, type);
		return result;
	}
	long AddFileToZip(LPCTSTR FileName)
	{
		long result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x42, DISPATCH_METHOD, VT_I4, (void*)&result, parms, FileName);
		return result;
	}
	long Convert2Zip(LPCTSTR strNew)
	{
		long result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x43, DISPATCH_METHOD, VT_I4, (void*)&result, parms, strNew);
		return result;
	}
	CString GetDevSN(long Index)
	{
		CString result;
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x44, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, Index);
		return result;
	}
	long ShowDevSettingWindow()
	{
		long result;
		InvokeHelper(0x45, DISPATCH_METHOD, VT_I4, (void*)&result, NULL);
		return result;
	}
	CString Base64Encode(LPCTSTR strFileName)
	{
		CString result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x46, DISPATCH_METHOD, VT_BSTR, (void*)&result, parms, strFileName);
		return result;
	}
	long Base64Decode(LPCTSTR strFileDecode, LPCTSTR strFileSaveFileName)
	{
		long result;
		static BYTE parms[] = VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x47, DISPATCH_METHOD, VT_I4, (void*)&result, parms, strFileDecode, strFileSaveFileName);
		return result;
	}
	void OpenAutomaticExposure(long bIsOpenAE)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x48, DISPATCH_METHOD, VT_EMPTY, NULL, parms, bIsOpenAE);
	}
	void SetCropMode(long bCropMode)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x49, DISPATCH_METHOD, VT_EMPTY, NULL, parms, bCropMode);
	}
	...
	long SetVideoParameter(long para1, long para2, long lvalue, long flag)
	{
		long result;
		static BYTE parms[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x4b, DISPATCH_METHOD, VT_I4, (void*)&result, parms, para1, para2, lvalue, flag);
		return result;
	}
	long AddFileToTiff(LPCTSTR FileName)
	{
		long result;
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0x4c, DISPATCH_METHOD, VT_I4, (void*)&result, parms, FileName);
		return result;
	}
	long ConvertToTiff(LPCTSTR strNew, long mode)
	{
		long result;
		static BYTE parms[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0x4d, DISPATCH_METHOD, VT_I4, (void*)&result, parms, strNew, mode);
		return result;
	}
