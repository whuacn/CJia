...
{
    public partial class UserManageView : CJia.Editors.View
    {
        ...
        private void btnSelectUser_LinkClicked(object sender, DevExpress.XtraNavBar.NavBarLinkEventArgs e)
        {
            string pageTitle = (sender as DevExpress.XtraNavBar.NavBarItem).Caption;
            if (!isExistPage(pageTitle))
            {
                UI.UserSelectView usuc = new UserSelectView();
                ShowPage(pageTitle, usuc);
            }
        }
