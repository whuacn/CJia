...
{
    public partial class LoginView : CJia.PEIS.Tools.View,CJia.PEIS.Views.ILoginView
    {
        public LoginView()
        {
            InitializeComponent();
        ...
        void Init()
        {
            string userNO = CJia.PEIS.Tools.ConfigHelper.GetAppStrings("UserNO");
        ...
        { 
            ...
            CJia.PEIS.Tools.ConfigHelper.UpdateAppStrings("UserNO", userNO);
        }
        #endregion
