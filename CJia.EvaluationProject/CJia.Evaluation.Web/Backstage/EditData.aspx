<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditData.aspx.cs" Inherits="CJia.Evaluation.Web.Backstage.EditData" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <Items>
            <CKEditor:CKEditorControl ID="CKEditorControl1" runat="server" Height="249"></CKEditor:CKEditorControl>
        </Items>
        </ext:ContentPanel>
        <ext:Toolbar ID="Toolbar1" Position="Bottom" runat="server">
            <Items>
                <ext:ToolbarFill ID="ToolbarFill1" runat="server"></ext:ToolbarFill>
                <ext:Button runat="server" ID="btn_Save_Data" ValidateForms="sf_Edit" Icon="SystemSave" Text="保存" OnClick="btn_Save_Data_Click"></ext:Button>
