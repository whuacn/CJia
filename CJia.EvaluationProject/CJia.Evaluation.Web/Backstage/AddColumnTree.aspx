<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddColumnTree.aspx.cs" Inherits="CJia.Evaluation.Web.Backstage.AddColumnTree" %>
            ...
            <Toolbars>
                <ext:Toolbar ID="tbr_Search" Position="Bottom" runat="server">
                    <Items>
                        ...
                        <ext:Button runat="server" ID="btn_Save" Icon="SystemSave" Text="保存" ValidateForms="sf_Edit" OnClick="btn_Save_Click"></ext:Button>
