    ...
    public sealed partial class PatientsPage : BasePage, Views.IMyPatientsPageView
    {
        ...
        protected override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (e.Parameter != null)
            {
                ...
                this.PatientItemBackground = UI.NewSolidColorBrush("#ff215f0e");
                switch (t.Title)
                {
        ...
        private void gridPatientList_Tapped(object sender, TappedRoutedEventArgs e)
        {
            ...
            MobileMedicalDoctor.iCommon.Patient = patient;
        ...
        public void ExeShowPatientList(List<Data.Patient> PatientList)
        {
            ...
            MobileMedicalDoctor.iCommon.PatientList = PatientList.OrderBy<Data.Patient, string>(new Func<Data.Patient, string>(OrderByBed)); ;
