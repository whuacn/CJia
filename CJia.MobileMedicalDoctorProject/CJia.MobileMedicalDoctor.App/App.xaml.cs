...
using CJia.MobileMedicalDoctor;
    ...
    sealed partial class App : Application
    {
        ...
        private void OnSuggestionsRequested(SearchPane sender, SearchPaneSuggestionsRequestedEventArgs args)
        {
            ...
            if (queryText.Length > 0)
            {
                ...
                foreach (string suggestion in CJia.MobileMedicalDoctor.iCommon.SuggestionList)
                {
        ...
        private void OpenSearchPage(string QueryText)
        {
            ...
            else if (frame.Name == "SearchResultsPage.Frame")
            {
                return;
            }
