    ...
    public class LoginPresenter : CJia.PIVAS.Tools.Presenter<CJia.PIVAS.Models.LoginModel, CJia.PIVAS.Views.ILoginView>
    {
        ...
        void View_OnLogin(object sender, Views.LoginEventArgs e)
        {
            ...
            if (dt != null && dt.Rows != null && dt.Rows.Count == 1)
            {
                ...
                CJia.PIVAS.User.SetUser(true, long.Parse(dt.Rows[0]["user_id"].ToString()), dt.Rows[0]["user_no"].ToString(), dt.Rows[0]["user_name"].ToString(), dt.Rows[0]["dept_id"].ToString(), dt.Rows[0]["dept_name"].ToString(), dt.Rows[0]["USER_PASSWORD"].ToString(), dt.Rows[0]["LOGINTIME"].ToString());
