...
namespace CJia.PIVAS.Tools
{
    ...
    {
        private static Hashtable m_Code39 = new Hashtable();
        ...
        private static int m_Height = 40;
        /// <summary>
        /// 图形高
        /// </summary>
        ...
        private static Font m_ViewFont = null;
        /// <summary>
        /// 字体大小
        /// </summary>
        ...
        /// <returns>图形</returns>
        public static Bitmap GetCodeImage(string p_Text, Code39Model p_Model, bool p_StarChar)
        {
            string _ValueText = "";
            string _CodeText = "";
        ...
        private static void GetViewImage(Bitmap p_CodeImage, string p_Text)
        {
            if(m_ViewFont == null)
                return;
