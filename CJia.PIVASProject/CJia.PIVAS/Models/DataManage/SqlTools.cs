...
//        }
        ...
        public static string SqlQueryUser
        {
            get
            {
                return @"select us.user_id,us.user_no,us.user_name,us.user_password,us.dept_id,us.dept_name,sysdate as loginTime from  sm_user us where  status='1' and user_no=? and user_password=?";
            }
        }
        ...
        public static string SqlQueryAllUser
        {
            get
            {
                return @"select * from  sm_user us where  status='1'";
            }
        }
        ...
        public static string SqlInsertUser
        {
            get
            {
                return @"insert into sm_user
                          (user_id, user_no, user_name, user_password,dept_id,dept_name, status, create_by, create_date)
                        values
        ...
        public static string SqlQueryBatch
        {
            get
            {
                return @"select  rownum BATCH_NO,t.* from sm_batch_set t order by batch_time";
            }
        }
        ...
        public static string SqlQueryFrequency
        {
            get
            {
                return @"select * 
                        ...
                        where frequency_id not in(select frequency_id from sr_frequency_batch_set)";
            }
        }
        ...
        public static string SqlQueryPivas
        {
            get
            {
                return @"select * from sr_pivas_set where status='1'";
            }
        }
        ...
        public static string SqlInsertDeptUsage
        {
            get
            {
                return @"insert into sr_pivas_set
                          (pivas_set_id, office_id, office_name, usage_id, usage_name, status, create_by, create_date)
                        values
