...
namespace CJia.Net.Communication.Messengers
{
    ...
    public class RequestReplyMessenger<T> : IMessenger, IDisposable where T : IMessenger
    {
        ...
        /// </summary>
        private readonly SequentialItemProcessor<ICJiaMessage> _incomingMessageProcessor;
        ...
        public RequestReplyMessenger(T messenger)
        {
            ...
            _incomingMessageProcessor = new SequentialItemProcessor<ICJiaMessage>(OnMessageReceived);
        ...
        private sealed class WaitingMessage
        {
            ...
            /// </summary>
            public ICJiaMessage ResponseMessage { get; set; }
