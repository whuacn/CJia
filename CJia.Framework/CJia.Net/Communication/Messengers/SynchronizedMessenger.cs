...
namespace CJia.Net.Communication.Messengers
{
    /// <summary>
    ...
    public class SynchronizedMessenger<T> : RequestReplyMessenger<T> where T : IMessenger
    {
        ...
        /// </summary>
        private readonly Queue<ICJiaMessage> _receivingMessageQueue;
            ...
            : base(messenger)
        {
            ...
            _receivingMessageQueue = new Queue<ICJiaMessage>();
        ...
        public ICJiaMessage ReceiveMessage()
        {
        ...
        public ICJiaMessage ReceiveMessage(int timeout)
        {
            while (_running)
            {
                lock (_receivingMessageQueue)
        ...
        /// </summary>
        /// <returns>Received message</returns>
        public TMessage ReceiveMessage<TMessage>() where TMessage : ICJiaMessage
        {
        ...
        /// </param>
        /// <returns>Received message</returns>
        public TMessage ReceiveMessage<TMessage>(int timeout) where TMessage : ICJiaMessage
        {
