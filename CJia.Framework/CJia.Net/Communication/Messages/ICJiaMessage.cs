...
namespace CJia.Net.Communication.Messages
{
    ...
    public interface ICJiaMessage
    {
        ...
        void SerializeOwnedData(Net.Serialization.SerializationWriter writer, object context);
        ...
        void DeserializeOwnedData(Net.Serialization.SerializationReader reader, object context);
    }
}
