...
namespace CJia.Net.Communication.Protocols.BinarySerialization
{
    ...
    /// </summary>
    public class BinarySerializationProtocol : ICJiaWireProtocol
    {
        ...
        /// </returns>
        public IEnumerable<ICJiaMessage> CreateMessages(byte[] receivedBytes)
        {
            ...
            var messages = new List<ICJiaMessage>();
        ...
        /// </returns>
        /// <exception cref="CommunicationException">Throws CommunicationException if message is bigger than maximum allowed message length.</exception>
        private bool ReadSingleMessage(ICollection<ICJiaMessage> messages)
        {
