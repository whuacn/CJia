...
namespace CJia
{
    ...
    /// 缺省OleDb数据库访问组件
    /// </summary>
    public static class DefaultOleDb
    {
        ...
        {
            get { return ada; }
            set { ada = value; } //by dh add  用于连接两台server设置
        }
        /// <summary>
        /// 缺省数据库访问组件
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static Dictionary<string, List<string>> QueryDBConfig()
        {
            return ada.QueryDBConfig();
        }
        #endregion
