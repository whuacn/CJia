...
namespace CJia.Controls
{
    ...
    /// 实时查询下拉框
    /// </summary>
    public class CJiaRTLookUpMoreCol : DevExpress.XtraEditors.PopupContainerEdit
    {
        ...
        private void CJiaRTLookUp_TextChanged(object sender, EventArgs e)
        {
        ...
        /// <summary>
        /// 所要绑定的字段二维数组，例如{{ID,编号},{NAME，名称}}
        /// </summary>
        [Category("CJia 数据绑定"), Description("所要绑定的字段二维数组，例如{{ID,编号},{NAME，名称}}")]
            ...
            set
            {
                ...
                if (fields != null)
                {
                    for (int i = 0; i < fields.GetLength(0); i++)
                    {
                        ...
                        column.FieldName = fields[i, 0];
                        column.Caption = fields[i, 1];
                        column.Visible = true;
        ...
        public string Caption
        {
            ...
            set
            {
                caption = value; //gridColumn.Caption = caption; 
            }
        }
        ...
        public event EventHandler<CJiaRTLookUpMoreColArgs> GetData;
    ...
    /// 实时查询下拉框参数类
    /// </summary>
    public class CJiaRTLookUpMoreColArgs : EventArgs
    {
        /// <summary>
        /// 搜索值
        /// </summary>
